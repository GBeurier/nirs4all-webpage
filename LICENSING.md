# Licensing — nirs4all-org

`nirs4all-org` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-org` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-org` relies on third-party open-source components. Their licenses are summarized
